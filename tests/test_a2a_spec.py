...
def test_file_content(schema, resolver):
    ...
    validate_instance(
        instance_uri.model_dump(mode='json', exclude_none=True),
        'FileContent',
        schema,
        resolver,
    )
...
def test_artifact(schema, resolver):
    ...
    validate_instance(
        instance_chunk.model_dump(mode='json', exclude_none=True),
        'Artifact',
        schema,
        resolver,
    )
...
def test_get_task_push_notification_response(schema, resolver):
    ...
    validate_instance(
        instance_null.model_dump(mode='json', exclude_none=True),
        'GetTaskPushNotificationResponse',
        schema,
        resolver,
    )
...
def test_agent_provider(schema, resolver):
    ...
    validate_instance(
        instance_min.model_dump(mode='json', exclude_none=True),
        'AgentProvider',
        schema,
        resolver,
    )
